...
(function() {
  ...
  QRCodeModel.createData = function(typeNumber, errorCorrectLevel, dataList) {
    ...
    if (buffer.getLengthInBits() > totalDataCount * 8) {
      throw new Error(
        `code length overflow. (${buffer.getLengthInBits()}>${totalDataCount *
          8})`,
      );
    }
    ...
    ? (function() {
        ...
        Drawing.prototype.draw = function(oQRCode) {
          ...
          for (let row = 0; row < nCount; row++) {
            ...
            for (let col = 0; col < nCount; col++) {
              aHTML.push(
                `<td style="border:0;border-collapse:collapse;padding:0;margin:0;width:${nWidth}px;height:${nHeight}px;background-color:${
