...
export function PrivacyPage({ userData, loggedIn, onLogoutClick }) {
  const classes = useStyles();

  return (
    <React.Fragment>
      <Helmet>
        <title>Privacy Policy - ImpGG</title>
        <meta
          name="description"
      ...
      <Container maxWidth="sm" component="main" className={classes.heroContent}>
        <h1>Privacy Policy for ImpGG</h1>

        <p>
          At ImpGG, accessible from https://imp.gg and https://impgg.com, one of
          our main priorities is the privacy of our visitors. This Privacy
          Policy document contains types of information that is collected and
          recorded by ImpGG and how we use it.
        </p>
        ...
        <p>
          ImpGG legal basis for collecting and using the personal information
        ...
        <ul>
          <li>ImpGG needs to perform a contract with you</li>
          <li>You have given ImpGG permission to do so</li>
          <li>
            Processing your personal information is in ImpGG legitimate
            interests
          </li>
          <li>ImpGG needs to comply with the law</li>
        </ul>

        <p>
          ImpGG will retain your personal information only for as long as is
        ...
        <p>
          ImpGG follows a standard procedure of using log files. These files log
        ...
        <p>
          Like any other website, ImpGG uses &#39;cookies&#39;. These cookies
        ...
        <p>
          ...
          advertising partners of ImpGG.
        </p>

        <p>
          Third-party ad servers or ad networks uses technologies like cookies,
          JavaScript, or Web Beacons that are used in their respective
          advertisements and links that appear on ImpGG, which are sent directly
        ...
        <p>
          Note that ImpGG has no access to or control over these cookies that
        ...
        <p>
          ImpGG&#39;s Privacy Policy does not apply to other advertisers or
        ...
        <p>
          ImpGG does not knowingly collect any Personal Identifiable Information
        ...
        <p>
          ...
          regards to the information that they shared and/or collect in ImpGG.
